...
<div id="container">
	...
	<div id="content">
        	...
        	<div id="content_main">
		<h3>Message Already Send to <%= request.getParameter("rec")%></h3>
		<br>
		...
		<%
			...
			PreparedStatement ps = con.prepareStatement("select * from MAILSENDER_SENTMAILS where sender=? and datetime=?");
			ps.setString(1,un);
			...
			out.print("<br><br><a href='inbox.jsp'>Back</a> | <a href='compose.jsp?sender="+rs.getString("receiver")+"&sub="+rs.getString("subject")+"&msg="+rs.getString("message")+"'>Send Again</a> | <a href='compose.jsp?sub="+rs.getString("subject")+"&msg="+rs.getString("message")+"'>Forward</a> | <a href='download.jsp?attachmentid="+rs.getString("attachment_id")+"'>Download Attachment</a>");
			con.close();
			}
			catch(Exception e)
			{
				System.out.println("displaysendmail.jsp : "+e);
			}
		%>
